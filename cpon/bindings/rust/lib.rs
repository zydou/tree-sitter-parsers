//! This crate provides ChainPack Object Notation (CPON) language support for the [tree-sitter][] parsing library.
//!
...
mod tests {
    ...
    fn test_can_load_grammar() {
        ...
        parser
            ...
            .expect("Error loading CPON grammar");
    }
}
